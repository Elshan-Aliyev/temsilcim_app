...
export const getVerificationPricing = () =>
  api.get('/verification/pricing');

export const getMyApplicationStatus = (token) =>
  api.get('/verification/my-application', {
    headers: { Authorization: `Bearer ${token}` }
  });
...
export const uploadVerificationDocument = (data, token) =>
  api.post('/verification/documents', data, {
    headers: { Authorization: `Bearer ${token}` }
  });

export const processVerificationPayment = (data, token) =>
  api.post('/verification/payment', data, {
    headers: { Authorization: `Bearer ${token}` }
  });

export const getPendingVerificationApplications = (token) =>
  api.get('/verification/applications/pending', {
    headers: { Authorization: `Bearer ${token}` }
  });

export const approveVerificationApplication = (userId, token) =>
  api.put(`/verification/applications/${userId}/approve`, {}, {
    headers: { Authorization: `Bearer ${token}` }
  });

export const rejectVerificationApplication = (userId, reason, token) =>
  api.put(`/verification/applications/${userId}/reject`, { reason }, {
    headers: { Authorization: `Bearer ${token}` }
  });
